...
class XRayDataset(Dataset):
    def __init__(
        ...
        self.prompt_mode = 'Phrases' # 'Phrases' / 'Locate' / 'Anatomy' / 'Metadata'
    ...
    def __getitem__(self, item: int):
        ...
        if self.mode in ['train', 'val']:
            ...
            if self.prompt_mode == 'Metadata' and self.meta_manager is not None:
            ...
            for ann in annotations:
                ...
                #  'Phrases' / 'Locate' / 'Anatomy' / 'Metadata' 
                if self.prompt_mode == 'Metadata' and meta_str:
                    phrase = f"{c}. {meta_str}"
                elif self.prompt_mode == 'Phrase' :
                    phrase = f"{c}."
                elif self.prompt_mode == 'Locate' :
                    phrase = f"{LOCATION_DESCRIPTION(c)}"
                else :
                    phrase = f"{ANATOMY_DESCRIPTION(c)}"
