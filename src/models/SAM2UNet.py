...
class SAM2UNet(nn.Module):
    def __init__(self, model_size = 'large', checkpoint_path=None) -> None:
        ...
        if model_size == 'tiny' :
            ...
            rfb_channels = [96, 192, 384, 768]
        elif model_size == 'base' :
            model_cfg = "sam2_hiera_b+.yaml"
            rfb_channels = [112, 224, 448, 896]
        elif model_size == 'large' :
            model_cfg = "sam2_hiera_l.yaml"
            rfb_channels = [144, 288, 576, 1152]
        else : 
            raise ValueError(f"Unkone model size: {model_size}")
        ...
        self.rfb1 = RFB_modified(rfb_channels[0], 64)
        self.rfb2 = RFB_modified(rfb_channels[1], 64)
        self.rfb3 = RFB_modified(rfb_channels[2], 64)
        self.rfb4 = RFB_modified(rfb_channels[3], 64)
        self.up1 = (Up(128, 64))
        self.up2 = (Up(128, 64))
        self.up3 = (Up(128, 64))
        self.up4 = (Up(128, 64))
